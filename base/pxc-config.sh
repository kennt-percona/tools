...
echo "    --wsrep-new-cluster  > $NODE_DATADIR/node.err 2>&1 &" >> ./$NEW_CLUSTER_SCRIPT_NAME
...
echo "    --port=$RBASE2 \\" >> ./$JOIN_CLUSTER_SCRIPT_NAME
...
echo "    > $NODE_DATADIR/node.err 2>&1 &" >> ./$JOIN_CLUSTER_SCRIPT_NAME
