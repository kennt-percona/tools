...
echo "    --wsrep_provider_options=\"evs.version=1;gmcast.listen_addr=tcp://$LADDR4;gmcast.segment=10\" \\" >> ./start_pxc10
...
echo "    --options=\"evs.version=1;gmcast.listen_addr=tcp://$LADDR10;gmcast.segment=0\" \\" >> ./start_arb
